...
int menu(int,int,int,char a[25],char b[25],char c[25],char d[25],char e[25],char f[25],char g[25],char title[40],char under[2]);
void main_menu();
...
void box(int x,int y,int width,int height)
 ...
 gotoxy(x+width,y+height);cputs("1/4");
 }


//Default Colour Settings
int default_back=BLACK;
int default_fore= GREEN;
int sel_back_color=YELLOW; //Selected Back Colour
int sel_text_color=BLUE; //Selected Text Colour
int back_color=BLACK; //Default Back Colour
int text_color=BROWN; //Default Text Colour
...
int menu(int x,int y,int num,char a[25],char b[25],char c[25],char d[25],char e[25],char f[25],char g[25],char title[40], char under[2])
 {
 char h[25]="";
 char ch;
